...
import { getApiConfig } from '../lib/backend';
...
const Settings: React.FC = () => {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      // Step 1: Verify current password via the same login endpoint the app uses
      const verifyRes = await fetch(`${apiConfig.baseUrl}/api/auth/login`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ username: storedUser.username || storedUser.email, password: passwordForm.current })
      });
      if (!verifyRes.ok) {
      ...
      if (!updateRes.ok) {
        ...
        setPasswordError(errData.message || errData.error || 'Failed to update password.');
        return;
      }
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg">
                    ...
                    <button
                      onClick={() => { setShowPasswordModal(true); setPasswordError(null); setPasswordSuccess(false); setPasswordForm({ current: '', newPass: '', confirm: '' }); }}
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6 relative">
            ...
            <p className="text-sm text-gray-500 mb-5">Enter your current password and choose a new one.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-end space-x-3 pt-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm disabled:opacity-60 disabled:cursor-not-allowed"
                  >
